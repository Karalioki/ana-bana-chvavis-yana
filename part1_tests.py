...
class DESTest(unittest.TestCase):
    ...
    def test_system_state(self):
        ...
        self.assertEqual([s.buffer_content, s.server_busy], [1, True],
                         msg="Error in SystemState. Wrserver_busyong int indicates queue length, wrong bool server busy.")
        self.assertEqual(s.add_packet_to_server(), False,
        ...
        # check behavior ofself.add_packet_to_server() function complete_service()
        s.complete_service()
